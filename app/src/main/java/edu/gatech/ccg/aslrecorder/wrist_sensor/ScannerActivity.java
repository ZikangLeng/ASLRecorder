package edu.gatech.ccg.aslrecorder.wrist_sensor;
        ...
        mwBoard.connectAsync()
                ...
                .continueWith(task -> {
                    if (!task.isCancelled()) {
                        ...
                        if (btDevice != null){
                            Log.i("MyTag", "btdevice is not null in scanner");
                        }
                        Intent navActivityIntent = new Intent(ScannerActivity.this, SplashScreenActivity.class);
                        navActivityIntent.putExtra("WRIST", btDevice);
